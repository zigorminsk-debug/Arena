...
В релизе лежит именно debug-APK — он всегда устанавливается и обновляется поверх прошлых
версий. Если вы задали секреты подписи (см. ниже), в релиз дополнительно попадает
подписанный `ArenaMobile-<версия>-build<номер>.apk` — уменьшенный R8-сборкой.
Неподписанный release-APK остаётся только в артефактах: установить его без подписи нельзя.
